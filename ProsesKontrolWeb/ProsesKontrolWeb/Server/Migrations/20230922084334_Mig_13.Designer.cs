...
namespace ProsesKontrolWeb.Server.Migrations
{
    ...
    [Migration("20230922084334_Mig_13")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProsesKontrolWeb.Shared.Models.ProsesModel", b =>
                {
                    ...
                    b.Property<int?>("UniteModelId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UniteModelId");

                    b.ToTable("ProsesModels");
                });

            modelBuilder.Entity("ProsesKontrolWeb.Shared.Models.UniteModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("KosulNo")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("UniteModels");
                });
            ...
            modelBuilder.Entity("ProsesKontrolWeb.Shared.Models.ProsesModel", b =>
                {
                    b.HasOne("ProsesKontrolWeb.Shared.Models.UniteModel", "UniteModel")
                        .WithMany()
                        .HasForeignKey("UniteModelId");

                    b.Navigation("UniteModel");
                });
